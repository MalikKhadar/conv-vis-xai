...
const ExplanationButtons = ({ activeVisualizationObject, setActiveVisualizationName, visualizationObjects, datapointNum, setDatapointNum, guided }) => {
  ...
  const datapoints = [
    { value: 0, label: 'Local (data point 0)' },
    { value: 1, label: 'Local (data point 1)' },
    { value: 2, label: 'Local (data point 2)' },
    { value: 3, label: 'Local (data point 3)' }
  ];
